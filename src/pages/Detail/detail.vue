<template>
  <div id="detail">
    <section class="user-info">
      <img src="@/img/mylogo.jpg" alt="" class="avatar">
      <h3>前端异步大揭秘</h3>
      <p>
        <router-link to="/user">Nature</router-link>
        发布于3天前
      </p>
    </section>
...
<span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">grid-row</span>: third-line / <span class="hljs-number">4</span>;
      ...
      <h3 class="grid-area">grid-area</h3>
...
<style scoped src="./detail.scss" lang="scss"></style>
